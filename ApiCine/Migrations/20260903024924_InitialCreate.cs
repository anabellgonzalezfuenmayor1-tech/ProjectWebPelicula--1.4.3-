        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RutaImagen = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    es_vista = table.Column<bool>(type: "bit", nullable: false),
                    RutaTrailer = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeliculasU", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PeliculasU_PeliculasId",
                table: "PeliculasU",
                column: "PeliculasId");

            migrationBuilder.CreateIndex(
                name: "IX_PeliculasU_UsuariosId",
                table: "PeliculasU",
                column: "UsuariosId");
        }
